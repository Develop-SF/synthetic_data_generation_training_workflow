...
WS_DIR="${PWD}"
OUTPUT_WAREHOUSE="${PWD}/kitchenware_data01/distractors_warehouse"
OUTPUT_ADDITIONAL="${PWD}/kitchenware_data01/distractors_additional"
OUTPUT_NO_DISTRACTORS="${PWD}/kitchenware_data01/no_distractors"
...
./python.sh $SCRIPT_PATH --height 1080 --width 1920 --num_frames 100 --distractors None --data_dir $OUTPUT_WAREHOUSE  --ws_dir $WS_DIR
